	...
	<div id="create-share-link" class="col-sm-12  ">
		...
		<div  class="col-md-10    " style="padding-left: 0px;" >
			<input id="share_tagName"  class="form-control enterInput"  
				style="border-radius:5px;border:1px solid #ddd;height: 40px;" placeholder="输入要共享的网页的标签"  type="text" value="网购发现"/>
		</div>
		
		<div  class="col-md-10    " style="padding-left: 0px;" >
			<input id="share_type"  class="form-control enterInput"  
				style="border-radius:5px;border:1px solid #ddd;height: 40px;" placeholder="输入要共享的网页的类别"  type="text" value="commodity"/>
		</div>
