...
<body>
	...
	<div class="container col-sm-12 clearfix "
		...
		<div id="pageMain" class="col-sm-8 col-xs-12 no-padding  ">
			...
			<%--
			<div id="create-share-link" class="col-sm-offset-2 col-sm-10"
				...
				<div class="col-sm-10  " style="padding-left: 0px;">
					...
					<div class="col-md-2 " style="padding-left: 0px;">
						 <input class="form-control enterInput  " id="share_fulidou"
							style="border-radius: 5px; border: 1px solid #ddd; height: 40px;"
							placeholder="福利豆" type="text" value="" title="需福利豆"/>
					</div>
					<div class="col-md-2  ">
					...
					<input id="create-share-link-btn" class="btn btn-primary col-sm-2 pull-right"
						style="height: 40px; border-radius: 5px;" type="button" value="发布"
						title="奖励  <%=FuliDou.createSharePageScore%>个 福利豆"> <span class="col-md-4 pull-right"
		...
		<div class="col-sm-4 col-xs-12"
			...
			<div class="col-sm-12   " style="margin-top: 60px;"></div>
