<%@page import="com.tgy.entity.VisitHistory"%>
<%@page import="com.tgy.service.VisitHistoryService"%>
...
List<VisitHistory> hostories = vs.list(new ConditionMap().add("responseUserID", loginUserID), null, 0);
List<User> users = new ArrayList<User>();
for(VisitHistory h : hostories){
	String userID = h.requestUserID;
...
<body>
	...
	<div class="  col-sm-12" style=""><h3>访问过我</h3></div>
	<!-- 主体内容 -->
	...
	<input type="hidden" id="pageID-level2" value="personal-social-visitors">
