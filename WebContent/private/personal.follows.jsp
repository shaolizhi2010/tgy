...
List<Follows> follows = fos.list(new ConditionMap().add("fromUserID", loginUserID), null, 0);
List<User> users = new ArrayList<User>();
for(Follows follow : follows){
	String toUserID = follow.toUserID;
...
<body>
	...
	<input type="hidden" id="pageID-level2" value="personal-social-follows">
