...
<script
	src="<%=request.getContextPath()%>/javascripts/jquery-1.11.1.min.js"></script>
<script
	src="<%=request.getContextPath()%>/javascripts/jquery.cookie.js"></script>
<script
	src="<%=request.getContextPath()%>/javascripts/bootstrap.min.js"></script>
<script src="<%=request.getContextPath()%>/javascripts/angular.min.js"></script>
