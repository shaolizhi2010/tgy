...
<div class=" col-sm-7 container no-padding tabs ">
	<a id="menu-index-all" href="<%=request.getContextPath()%>/all" class="   no-padding " style=" "><span class="tabs-tab hoverAble-head">全部</span> </a>
	<a id="menu-index-article" href="<%=request.getContextPath()%>/article" class="   no-padding " style=" "><span class="tabs-tab hoverAble-head">自媒体</span> </a>
	<a id="menu-index-baidupan" href="<%=request.getContextPath()%>/baidupan" class="   no-padding " style=" "><span class="tabs-tab hoverAble-head">百度盘资源</span> </a>
