...
<%
	...
	GroupDiscussService discussService = new GroupDiscussService();
	List<GroupDiscuss> discusses = discussService.list(new ConditionMap().add("groupID", groupID) , "-createDate", 10);
...
%>
	...
	<div class=" container col-sm-12 sub-page-with-title"  >
		...
		<div class="col-sm-12 no-padding" style=" ">
			...
			<p class=" col-sm-12 container no-padding" style=" background-color:#f2f2f2;  padding:10px;padding-left:  15px;  font-size: 12px;font-weight: normal;word-wrap: break-word; word-break: break-all;">
		...
		%>
		 <div class="col-sm-12  no-padding " style="  ">
				<div  style="margin-top: 5px;" >
		         		<textarea   id="createGroupDiscussMessage"  class="form-control" rows="2" placeholder=""></textarea> 
	         	</div>
	         	<div  style="margin-top: 4px;" >
	              <button onclick="createGroupDiscussFunction()" id="createFolder-ok" type="button"
