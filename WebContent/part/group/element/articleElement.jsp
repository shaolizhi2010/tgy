...
InterestGroupPageService  as = new InterestGroupPageService();
a = as.byID(pageID); 
...
<div class="col-sm-12 article-container no-padding ">
	...
	<div class="col-sm-12 no-padding">
		<a   href='<%=request.getContextPath()+"/"+a.type.toString()%>' class=" col-sm-4 article-tag ">分类：<%=a.type %></a>
	</div>
		...
		<div class="col-sm-8 no-padding">
			...
			<div class="col-sm-12 container no-padding">
				...
				<div class="    article-author pull-right">
					...
					-->
					<a target="_blank" class="article-authorName-url" href="<%=authorUrl%>"  title = "<%=a.authorName %>" >
						<span class="  article-authorName-span ">来源： <%=a.authorName %> 的网址分享</span>
					</a>
