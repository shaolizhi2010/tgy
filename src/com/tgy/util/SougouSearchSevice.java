...
public class SougouSearchSevice {
	...
	public List<Page> search(String keyword ) {
		try {
			...
			String url = "http://www.sogou.com/web?query=site%3Apan.baidu.com+"+keyword+"&ie=utf8";
...
//			String s  = SimpleConnecter.connect(url, "utf-8");
			...
			httpget.setHeader("Referer", "www.sougou.com");  
			...
			pageSource = pageSource.replaceAll("[\\000]*", "") ;
			...
			for(Element e : elementList){
				...
				if(attr!=null){
					...
					if(StringUtils.startsWith(href, "http://pan.baidu.com") && !StringUtils.startsWith(e.getValue(), "http://pan.baidu.com")){
			...
			System.out.println(" SougouSearch Exception : "+e.getMessage());
