...
public class YahooSearchSevice {
	...
	public List<Page> search(String keyword ) {
		try {
			...
			String url = "https://sg.search.yahoo.com/search?p=site%3Apan.baidu.com+"+keyword;
...
//			String s  = SimpleConnecter.connect(url, "utf-8");
			...
			for(Element e : elementList){
				...
				if(attr!=null){
					...
					if(StringUtils.contains(href, "http%3a%2f%2fpan.baidu.com")){
						//System.out.println(e.getValue());
					//	System.out.println(href);
						Page p = new Page();
						p.name = e.getValue();
						href = URLDecoder.decode(href,"utf-8");
						p.url = "http://pan.baidu.com" + StringUtils.substringBetween(href, "http://pan.baidu.com","/RK");
						results.add(p);
					}
				}
			}
