...
public class GusoukSearchSevice {
	...
	public List<Page> search(String keyword ) {
		try {
			...
			String url = "http://www.somjj.com/search?q="+keyword+"+site%3Apan.baidu.com";
...
//			
			...
			httpget.setHeader("Referer", "www.somjj.com");  
...
//
			...
			System.out.println("GusoukSearchSevice Exception : "+e.getMessage());
...
//	
	...
	public static void main(String[] args) {
		List<Page> pages = new GusoukSearchSevice().search("abc");
