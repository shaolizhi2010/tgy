...
public class GetGroupPageInfoThread  implements Runnable{

	String url ;
	String pageID ;
	
	public GetGroupPageInfoThread(String url,String pageID  ){
		this.url = url;
		this.pageID = pageID;
	}
...
//		}
//		
//		InterestGroupPageDao dao = new InterestGroupPageDao();
//		InterestGroupPage page = dao.byID(pageID);
